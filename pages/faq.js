          ...
          content: (
            <div>
              ...
              <p>
                ...
                <br />
                Never share your MetaMask recovery phrase with anyone. The
                Crypto Byte team will <b>never</b> ask for it.
              </p>
            </div>
          ),
        },
        ...
        content: {
          content: (
            <div>
              ...
              <p>
                Note: for security reasons always install browser extensions
          ...
          content: (
            <div>
              ...
              <ul>
                ...
                <li>
                  Go to{' '}
                  <Link route={`/tokens/${currentAccount}`}>
                    <a>My Tokens</a>
                  </Link>{' '}
                  tab
                </li>
